import { validarAccesoTexto } from "../funciones/accessControl.js";

const textoBienvenida = document.getElementById("textBienvenida");

window.addEventListener("DOMContentLoaded", () => {
    validarAccesoTexto(textoBienvenida);
});
